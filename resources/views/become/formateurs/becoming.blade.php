      ...
      <div class="container">
        <div class="row">
          <div class="offset-lg-1 col-lg-7 col-12">
            ...
            <div class="mb-10">
              <!-- heading -->
              <h1 class="mb-3 display-4 fw-bold">Dévenur  &amp; Formateur </h1>
              <!-- lead -->
              <p class="mb-0 lead pe-lg-10 ">
              Renseignez vos informations , notre equipe procederons à une verification à moins de 30 minutes ,
              et vous obtiendrez une réponse rapide.
              </p>
            </div>
          </div>
        </div>
                              ...
                              <div class="card-body p-6">
                                ...
                                <div class="row gx-3">
                                  ...
                                  <div class="mb-4 col-12 col-md-12">
                                    <!-- label -->
                                    <label class="form-label" for="lname">Nom et Prénom <span class="text-danger">*</span></label>
                                    <!-- input -->
                                    <input type="text" id="lname" class="form-control" placeholder="KGSDEV TECHNLOGIE" name="fullname" value="{{old('fullname')}}">
                                  </div>
                                  <div class="mb-4 col-12 col-md-12">
                                    <!-- label -->
                                    <label class="form-label" for="email">Télephone <span class="text-danger" >*</span></label>
                                    <!-- input -->
                                  ...
                                  <div class="mb-4 col-12 col-md-12">
                                    <!-- label -->
                                    <label class="form-label" for="phone">Whattsap Contact <span class="text-danger">*</span></label>
                                    <!-- input group -->
                                    <div class="input-group mb-1">
                                      <span class="input-group-text" id="phone">+91</span>
                                      <!-- input -->
                                      <input type="text" class="form-control" name="whattsapp"  placeholder="Mobile Whattsap" aria-label="Mobile Number" aria-describedby="phone" value="{{old('whattsapp')}}">
                                    </div>
                                    <!-- text -->
                                  ...
                                  <div class="mb-4 col-12 col-md-12">
                                    ...
                                    <div class="fs-5 text-dark mb-2">Genre </div>
                                    <!-- radio -->
                                  ...
                                  <div class="mb-4 col-12 col-md-12">
                                    <!-- radio -->
                                    <label class="form-label" for="resume">Votre Photo de profile </label>
                                    <div class="input-group mb-1">
                                      <input type="file" name="avatar" class="form-control" id="resume">
                                      <label class="input-group-text" for="resume">Télecharger</label>
                                    </div>
                                    <!-- text -->
                                    <span class="fs-6">PNG, JPEG,  JPGE, Max: 2 MB. </span>
                                  </div>

                                  <div class="mb-4 col-12 col-md-12">
                                    <!-- label -->
                                    <label class="form-label" for="lname">Perfomance  <span class="text-danger">*</span></label>
                                    <!-- input -->
                                  ...
                                  <div class="mb-4 col-12 col-md-12">
                                    <!-- label -->
                                    <label class="form-label" for="lname">Décrivez-vous briévement  <span class="text-danger">*</span></label>
                                    <!-- input -->
                                  ...
                                  <div class="mb-4 col-12 col-md-12">
                                    ...
                                    <div class="form-check">
                                      ...
                                      <label class="form-check-label fs-6" for="formId">
                                       Acceptez-vous de recevoir des notifications sur les possibiles oportuinités
                                      </label>
                                    </div>
                                  </div>
              ...
              <div class="col-md-4 col-12">
                ...
                <div class="card bg-light shadow-none">
                  ...
                  <div class="card-body p-5">
                    ...
                    <h3 class="mb-3">On registering you
                      can</h3>
                    <ul class="list-unstyled text-dark mb-0">
                      <li class="d-flex align-items-start mb-3"><i class="mdi mdi-check-circle me-2 text-success"></i>Build your profile and let
                        recruiters find you.</li>
                      <li class="d-flex align-items-start mb-3"><i class="mdi mdi-check-circle me-2 text-success"></i>Get
                        job postings delivered right
                        to your email.</li>
                      <li class="d-flex align-items-start"><i class="mdi mdi-check-circle me-2 text-success"></i>Find a
