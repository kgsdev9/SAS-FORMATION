...
@section('content')
  <!-- Page Content -->
  <section class="py-xl-18 py-10 bg-auto bg-light hero-graphics">
    <div class="container">
      <!-- Hero Section -->
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 col-md-12">
          <div class="text-center">
            <h1 class="display-2 fw-bold mb-3 text-primary"><span class="text-dark px-3 px-md-0">Build Better</span>
            ...
            <div class="mt-8 mb-0">
              <ul class="list-inline">
                <li class="list-inline-item text-dark fw-semibold lh-1 fs-4 me-3   mb-2 mb-md-0"><span
                    class="icon-shape icon-xs rounded-circle bg-light-success text-center me-2"><i
                      class="mdi mdi-check text-success "></i></span><span class="align-middle">30,000 online
                    courses</span></li>
                <li class="list-inline-item text-dark fw-semibold lh-1 fs-4  me-3    mb-2 mb-md-0"><span
                    class="icon-shape icon-xs rounded-circle bg-light-success text-center me-2"><i
                      class="mdi mdi-check text-success "></i></span><span class="align-middle">Expert
                    instruction</span></li>
                <li class="list-inline-item text-dark fw-semibold lh-1 fs-4"><span
                    class="icon-shape icon-xs rounded-circle bg-light-success text-center me-2"><i
                      class="mdi mdi-check text-success "></i></span><span class="align-middle">Lifetime access</span>
                </li>
              </ul>
            </div>
          </div>
  ...
  <!-- container -->
  <section class="bg-white py-lg-16 py-7">
    <div class="container">
      <!-- row -->
      <div class="row mb-6 justify-content-center">
        <!-- caption -->
        <div class="col-lg-8 col-md-12 col-12 text-center">
          <span class="text-primary mb-0 d-block text-uppercase fw-semibold ls-xl">Featured In</span>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-md-4 col-6">
          <div class="mb-4 text-center">
            <img src="../../assets/images/brand/gray-logo-pinterest.svg" alt="logo">
          </div>
        </div>
        <!-- logo -->
        <div class="col-lg-2 col-md-4 col-6">
  ...
  <section class="py-7 py-lg-18">
    <div class="container">
      <div class="row mb-10 justify-content-center">
        <div class="col-lg-8 col-md-12 col-12 text-center">
          <!-- caption -->
          <span class="text-primary mb-3 d-block text-uppercase fw-semibold ls-xl">Why Learn with Geeks</span>
          <h2 class="mb-2 display-4 fw-bold ">Build better skills,faster</h2>
          <p class="lead mb-0">Explore new skills, deepen existing passions, and get lost in creativity. What you find
        ...
        <div class="col-lg-3 col-md-6 col-12">
          ...
          <div class="mb-4">
            ...
            <div class="mt-4">
              ...
              <p class="fs-4 mb-0">Lorem ipsum dolor sit amet, lorem consectetur adipiscing elit.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-12">
          ...
          <div class="mb-4">
            ...
            <div class="mt-4">
              ...
              <p class="fs-4 mb-0">Pellentesque eu mi rhoncus, rhoncus tortor a, interdum nisi.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-12">
          ...
          <div class="mb-4">
            ...
            <div class="mt-4">
              ...
              <p class="fs-4 mb-0">Quisque tempus lectus cursus, imperdiet eros vel, pulvinar arcu.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-12">
          ...
          <div class="mb-4">
            ...
            <div class="mt-4">
              ...
              <p class="fs-4 mb-0">Etiam dignissim est tristique ex porta, bibendum commodo.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Top courses-->
  <section class="pt-5 pb-8 py-lg-16 bg-light-gradient-bottom">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="mb-8">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="nav nav-lb-tab mb-6" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <a class="nav-link" id="pills-javascript-tab" data-bs-toggle="pill" href="#pills-javascript" role="tab"
                aria-controls="pills-javascript" aria-selected="false">Javascript</a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="nav-link" id="pills-development-tab" data-bs-toggle="pill" href="#pills-development" role="tab"
  ...
  <section class="py-7 py-lg-16  ">
    <div class="container">
      <div class="row  justify-content-center">
        <!-- caption -->
        <div class="col-lg-8 col-md-12 col-12">
          <div class="mb-8  text-center">
            <span class="text-primary mb-3 d-block text-uppercase fw-semibold ls-xl">World-class Instructors</span>
            <h2 class="mb-2 display-4 fw-bold">Classes Taught by Industry Expert</h2>
            <p class="lead mb-0">Geeks teachers are icons, experts, and industry rock stars excited to share their
      ...
      <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
          ...
          <div class="card mb-4 card-hover">
            ...
            <div class="card-img-top">
              <img src="../../assets/images/instructor/instructor-img-1.jpg" alt="img" class="rounded-top-md img-fluid">
            </div>
            <!-- card body -->
            <div class="card-body">
              <h3 class="mb-0 fw-semibold"> <a href="#" class="text-inherit">Mary Roberts</a></h3>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
          ...
          <div class="card mb-4 card-hover">
            <!-- img -->
            <div class="card-img-top">
              <img src="../../assets/images/instructor/instructor-img-2.jpg" alt="img" class="rounded-top-md img-fluid">
            </div>
            <!-- card body -->
            <div class="card-body">
              <h3 class="mb-0 fw-semibold"><a href="#" class="text-inherit">Esther Howard</a></h3>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12">
          ...
          <div class="card mb-4 card-hover">
            <!-- img -->
            <div class="card-img-top">
              <img src="../../assets/images/instructor/instructor-img-3.jpg" alt="img" class="rounded-top-md img-fluid">
            </div>
            <!-- card body -->
            <div class="card-body">
              <h3 class="mb-0 fw-semibold"><a href="#" class="text-inherit">Ross Johnson</a></h3>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 d-lg-none d-xl-block">
          ...
          <div class="card mb-4 card-hover">
            <!-- img -->
            <div class="card-img-top">
              <img src="../../assets/images/instructor/instructor-img-4.jpg" alt="img" class="rounded-top-md img-fluid">
            </div>
            <!-- card body -->
            <div class="card-body">
              <h3 class="mb-0 fw-semibold"><a href="#" class="text-inherit">James Davies</a></h3>
        ...
        <div class="col-lg-11 col-md-12">
          <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-md-5 col-12 mb-6">
              <h1 class="display-3 fw-bold">Become an Instructor</h1>
            </div>
            <div class="offset-lg-1 col-lg-6 col-md-7 col-12 mb-6">
              <!-- para -->
              <p class="lead mb-0">Top instructors from around the world teach millions of students on Geeks. We provide
                the
          ...
          <div class="row">
            <div class="col-lg-4 col-md-4 col-12 mb-3">
              ...
              <p class="fs-4 mb-0">Earn money every time a student purchases your course. Get paid monthly through <span
                  class="text-dark">Paypal </span>or <span class="text-dark">Payoneer</span>.</p>
            </div>
            <div class="col-lg-4 col-md-4 col-12 mb-3">
              <!-- text -->
              <h3 class="fw-semibold mb-2">Inspire students</h3>
              <p class="fs-4 mb-0">Help people learn new skills, advance their careers, and explore their hobbies by
                sharing your
                knowledge.</p>
            </div>
            <div class="col-lg-4 col-md-4 col-12 mb-3">
              ...
              <p class="fs-4 mb-0">Take advantage of our active community of instructors to help you through your course
                creation process.
              </p>
            </div>
            <!-- btn -->
      ...
      <div class="row  justify-content-center">
        <div class="col-lg-8 col-md-12 col-12 text-center">
          <div class="mb-8">
            ...
            <p class="lead mb-0">12+ million people are already learning on Geeks</p>
          </div>
              ...
              <div class="item">
                ...
                <div class="card border shadow-none">
                  ...
                  <div class="card-body p-5">
                    ...
                    <!-- para -->
                    <p class="lead text-dark font-italic fw-medium mb-0">"I started at stage zero. With Geeks I
                      was able to start learning online and eventually build up enough knowledge and skills to
                      transition
              ...
              <div class="item">
                ...
                <div class="card border shadow-none">
                  ...
                  <div class="card-body p-5">
                    ...
                    <!-- para -->
                    <p class="lead text-dark font-italic fw-medium mb-0">"Orci varius natoque penatibus et magnis dis
                      parturient montes,
                      nascetur ridiculus mus. Etiam vulputate euismod justo in consequat. Sed tempus elementum urnanisl
                      et lacus. "</p>
                  </div>
                  <!-- card footer -->
                  <div class="card-footer px-5 py-4">
              ...
              <div class="item">
                ...
                <div class="card border shadow-none">
                  ...
                  <div class="card-body p-5">
                    ...
                    <!-- para -->
                    <p class="lead text-dark font-italic fw-medium mb-0">"Sed pretium risus magna, ac efficitur nunc
                      rutrum imperdiet. Vivamus sed ante sed mi fermentum tempus. Nullam finibus augue eget felis
                      efficitur semper."</p>
                  </div>
                  <!-- card footer -->
                  <div class="card-footer px-5 py-4">
              ...
              <div class="item">
                ...
                <div class="card border shadow-none">
                  ...
                  <div class="card-body p-5">
                    ...
                    <!-- para -->
                    <p class="lead text-dark font-italic fw-medium mb-0">"Morbi quis posuere lacus. Morbi et metus sit
                      amet tellus dapibus aliquam. Morbi consectetur magna vel turpis lobortis lorem iopsum dolor sit
                      commodo."</p>
                  </div>
                  <!-- card footer -->
                  <div class="card-footer px-5 py-4">
              ...
              <div class="item">
                ...
                <div class="card border shadow-none">
                  ...
                  <div class="card-body p-5">
                    ...
                    <!-- para -->
                    <p class="lead text-dark font-italic fw-medium mb-0">" Curabitur sollicitudin mi et sagittis
                      egestas. Curabitur pellentesque nibh id enim hendrerit, at mollis neque rutrum. Sed nibh velit,
                      tristique et dolor vitae."</p>
                  </div>
                  <!-- card footer -->
                  <div class="card-footer px-5 py-4">
                    <div class="d-flex align-items-center">
              ...
              <div class="item">
                ...
                <div class="card border shadow-none">
                  ...
                  <div class="card-body p-5">
                    ...
                    <!-- para -->
                    <p class="lead text-dark font-italic fw-medium mb-0">"Vestibulum in lobortis purus. Quisque sem
                      turpis, hendrerit quis lacinia nec, rutrum nec velit. Nullam lobortis rhoncus tincidunt lorem
                      ispun dnascetur ridiculus mus. "</p>
                  </div>
                  <!-- card footer -->
                  <div class="card-footer px-5 py-4">
                    <div class="d-flex align-items-center">
              ...
              <div class="item">
                ...
                <div class="card border shadow-none">
                  ...
                  <div class="card-body p-5">
                    ...
                    <!-- para -->
                    <p class="lead text-dark font-italic fw-medium mb-0">"Praesent sit amet ornare magna, vitae
                      consequat arcu. Vestibulum at dictum erat, a fringilla ante. Nam et nibh ut nunc rutrum suscipit
                      quis non neque. Nulla facilisi."</p>
                  </div>
                  <div class="card-footer px-5 py-4">
                    <div class="d-flex align-items-center">
  ...
  <!-- call to action -->
  <section class="py-lg-16 py-10 bg-gray-200"
