...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{asset('admin/images/favicon.ico')}}">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/switchery/0.8.2/switchery.min.js"></script>
        ...
        <!-- Layout config Js -->
        <script src="{{asset('admin/libs/gridjs/theme/mermaid.min.css')}}"></script>
        <!-- Bootstrap Css -->
        <link href="{{asset('admin/js/layout.js')}}" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart" aria-labelledby="page-header-cart-dropdown">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="m-0 fs-16 fw-semibold"> Recents Commandes</h6>
                                </div>
                                <div class="col-auto">
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('admin/images/products/img-10.png')}}" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-1">
                                            ...
                                            <p class="mb-0 fs-12 text-muted">
                                                Quantity: <span>2 x  300€</span>
                                            </p>
                                        </div>
                                        <div class="px-2">
                                            <h5 class="m-0 fw-normal"><span class="cart-item-price">500 €   </span></h5>
                                        </div>
                                        <div class="ps-2">
                        ...
                        <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border" id="checkout-elem">
                            <div class="d-flex justify-content-between align-items-center pb-3">
                                ...
                                <div class="px-2">
                                    <h5 class="m-0" id="cart-item-total">30000€</h5>
                                </div>
                            </div>
                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="my-3 text-center view-all">
                                        <button type="button" class="btn btn-soft-success waves-effect waves-light">
                                            Consulter les notifications <i class="ri-arrow-right-line align-middle"></i></button>
                                    </div>
                                </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{asset('assets/images/avatar/avatar-1.jpg')}}" alt="Header Avatar">
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <script src="{{asset('admin/js/jquery/jquery-3.6.0.min.js')}}"></script>
        ...
        <!-- App js -->
        <script src="{{asset('admin/js/pages/dashboard-job.init.js')}}"></script>
