                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                    ...
                    <div class="card px-4 pt-2 pb-4 shadow-sm rounded-top-0 rounded-bottom-0 rounded-bottom-md-2 ">
                        <div class="d-flex align-items-end justify-content-between  ">
                            ...
                            <div>
                                <a href="{{route('courses.create')}}" class="btn btn-primary d-none d-md-block">Create New
                                    Course</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="navbar-nav flex-column">
                                ...
                                <ul class="list-unstyled ms-n2 mb-4">
                                    ...
                                    <li class="nav-item active">
                                        <a class="nav-link" href="dashboard-instructor.html"><i
                                                class="fe fe-home nav-icon"></i>My
                                            Dashboard</a>
                                    </li>
                                    <!-- Nav item -->
                                    <li class="nav-item">
                                        <a class="nav-link" href="instructor-courses.html"><i
                                                class="fe fe-book nav-icon"></i>My Courses</a>
                                    </li>
                                    <!-- Nav item -->
                                    <li class="nav-item">
                                        <a class="nav-link" href="instructor-reviews.html"><i
                                                class="fe fe-star nav-icon"></i>Reviews</a>
                                    </li>
                                    <!-- Nav item -->
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="instructor-students.html"><i
                                                class="fe fe-users nav-icon"></i>Students</a>
                                    </li>
                                    <!-- Nav item -->
                                    <li class="nav-item">
                                    ...
                                    <!-- Nav item -->
                                    <li class="nav-item ">
                                        <a class="nav-link" href="instructor-quiz-result.html"><i class="fe fe-help-circle nav-icon"></i>Quiz Result</a>
                                      </li>
                                </ul>
                                <!-- Navbar header -->
                                ...
                                <ul class="list-unstyled ms-n2 mb-0">
                                    ...
                                    <!-- Nav item -->
                                    <li class="nav-item">
                                        <a class="nav-link" href="social-profile.html"><i
                                                class="fe fe-refresh-cw nav-icon"></i>Social
                                            Profiles</a>
                                    </li>
                                    <!-- Nav item -->
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="profile-privacy.html"><i
                                                class="fe fe-lock nav-icon"></i>Profile
                                            Privacy</a>
                                    </li>
                                    <!-- Nav item -->
                                    <li class="nav-item">
